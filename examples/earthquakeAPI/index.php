            ...
            success: function(data,status) {
              ...
              $('#earthquakeResult').html(data["metadata"].title + "<br>");
                 ...
                 var formattedTime = hours + ":" + minutes;
                  ...
                  $('#earthquakeResult').append(data['features'][i]['properties'].type + " - " + data['features'][i]['properties'].mag + " - " + data['features'][i]['properties'].place + " - " + formattedDate + ", " + formattedTime + "<br/>");
